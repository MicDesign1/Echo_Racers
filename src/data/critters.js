...
export const CRITTER_SHEETS = {
  ...
  // CraftPix predator plants: 4-direction facing. Idle 256×256 = 4×4 of 64px,
  // walk 384×256 = 6×4 of 64px. Row 0 down/front, row 1 up/back, row 2 left,
  // row 3 right. Credit: craftpix.net/file-licenses/
  plant1: {
    kind: 'plant4',
    ...
    drawScale: 1.5,
    yOffset: 0,
    rowForFacing: { down: 0, up: 1, left: 2, right: 3 },
  },
  plant2: {
    kind: 'plant4',
  ...
  // CraftPix slimes: 4-direction facing. Idle 384×256 = 6×4 of 64px,
  // walk 512×256 = 8×4 of 64px. Row 0 down/front, row 1 up/back, row 2 left,
  // row 3 right. Credit: craftpix.net/file-licenses/
  slime1: {
    kind: 'plant4',
    idleSrc: '/sprites/hub/critters/craftpix/slime1-idle.png',
    src: '/sprites/hub/critters/craftpix/slime1-walk.png',
    frameWidth: 64,
    frameHeight: 64,
    idleFrames: 6,
    walkFrames: 8,
  ...
  slime2: {
    kind: 'plant4',
    idleSrc: '/sprites/hub/critters/craftpix/slime2-idle.png',
    src: '/sprites/hub/critters/craftpix/slime2-walk.png',
    frameWidth: 64,
    frameHeight: 64,
    idleFrames: 6,
    walkFrames: 8,
  ...
  slime3: {
    kind: 'plant4',
    idleSrc: '/sprites/hub/critters/craftpix/slime3-idle.png',
    src: '/sprites/hub/critters/craftpix/slime3-walk.png',
    frameWidth: 64,
    frameHeight: 64,
    idleFrames: 6,
    walkFrames: 8,
